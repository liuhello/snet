...
{    
    ...
    public:
        ...
        virtual bool write(ByteArrayOutputStream* os) = 0;
        virtual bool read(ByteArrayInputStream* is) = 0;
    ...
    public:
        ...
        ~PingPacket(){}
        bool write(ByteArrayOutputStream* os);
        bool read(ByteArrayInputStream* is);
